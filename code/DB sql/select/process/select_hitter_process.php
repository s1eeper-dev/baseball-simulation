...
<html>
  ...
  <body>
    ...
    $team=$_POST['team'];
      ...
      $stmt  = oci_parse($conn, "select hitter.H#, hitter.HNAME,club.C#, club.CNAME, hitter.PA, hitter.AB, hitter.H, hitter.B2, hitter.B3, hitter.HR, hitter.GO, hitter.AO from hitter left join club on hitter.C#=club.C# where club.C#='".$team."'");
      oci_execute($stmt);
